const DEFAULT_SERVER_PROD1 = 'http://localhost:8086/api';
const DEFAULT_SERVER_TEST1 = 'http://localhost:8000/api';
...
const TESTSERVER_USER_NAME = 'love';
const TESTSERVER_PASSWORD = 'love1234';

const exerciseDayUrl = 'exerciseDays';
